...
const Friends = ({ referredUsers, referralCode }) => {
  ...
  return (
    <div className="container-fluid friends-wrapper d-flex flex-column justify-content-between p-0">
      <div
        className={`d-flex flex-column align-items-center justify-content-end gap-3 invite-friends-banner ${
      ...
      >
        ...
        <button
          ...
          onClick={() => {
            ...
            window.Telegram.WebApp.openTelegramLink(`https://t.me/share/url=${appLink}&startapp=${referralCode}`);
          }}
